                ...
                var Rive = (()=>{
                    ...
                    return function(Rive) {
                        ...
                        const fa = new function() {
                            function b() {
                                if (!a) {
                                    var t = document.createElement("canvas"), v = {
                                        alpha: 1,
                                        depth: 0,
                                        stencil: 0,
                                        antialias: 0,
                                    ...
                                    if (q) c = 2;
                                    else if (q = t.getContext("webgl", v)) c = 1;
                        ...
                        Rive.onRuntimeInitialized = function() {
                            ...
                            const e = Rive.RenderPath, f = Rive.RenderPaint, h = Rive.Renderer, g = Rive.StrokeCap, l = Rive.StrokeJoin, k = Rive.BlendMode, p = d.fill, r = d.stroke, t = Rive.FillRule.evenOdd;
                            let v = 1;
                            ...
                            s: function(b, a) {
                                ...
                                Y(b, {
                                    ...
                                    toWireType: function(d, e) {
                                        ...
                                        } else if (h) for(h = 0; h < f; ++h)k = e.charCodeAt(h), 255 < k && (jb(l), Q("String has UTF-16 code units that do not fit in 8 bits")), H[l + h] = k;
                                        else for(h = 0; h < f; ++h)H[l + h] = e[h];
                                        null !== d && d.push(jb, g);
                                        return g;
                                    },
                                    argPackAdvance: 8,
...
//# sourceMappingURL=index.e4c57a1a.js.map
